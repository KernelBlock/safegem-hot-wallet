...
package com.bankledger.safegem.scan.camera.open;
...
public final class OpenCameraInterface {
  ...
  public static OpenCamera open(int cameraId) {
    ...
    Camera.Size preSize = getCloselyPreSize(true, DPUtils.getScreenW(SafeGemApplication.getInstance()), DPUtils.getScreenH(SafeGemApplication.getInstance()), parameters.getSupportedPreviewSizes());
  ...
  private static Camera.Size getCloselyPreSize(boolean isPortrait, int surfaceWidth, int surfaceHeight, List<Camera.Size> preSizeList) {
    int reqTmpWidth;
    int reqTmpHeight;
