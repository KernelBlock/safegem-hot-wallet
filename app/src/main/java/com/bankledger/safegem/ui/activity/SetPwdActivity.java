...
public class SetPwdActivity extends MVPBaseActivity<ISetPwdView, SetPwdPresenter> implements ISetPwdView {
    ...
    public void onViewClicked() {
        ...
        mPresenter.register(phone, sms_code, newPwd.getText().toString());
    }
